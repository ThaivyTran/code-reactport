...
function About() {
  return (
    ...
    <p>Hello, World! Welcome to my coding react portfolio webpage! My name is Thaivy (ta-vy) and here's an introduction. I graduated high school in 2015, after I enlisted into the National Guard Army for 6 years. My MOS was 88M (heavy equipment operator), to keep it short basically I operate heavy up-amored vehicles. In July 2021, I was honorably discharged and now I'm looking at different career paths. Thus, is why I am currently enrolled in uPenn Full Stack boot camp part-time to advance my career.</p>
